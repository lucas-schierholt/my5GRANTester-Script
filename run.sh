...
# Load print methods
source <(curl -s https://raw.githubusercontent.com/lucas-schierholt/my5GRANTester-Script/main/utils/print.sh)
...
#    bash <(curl -s https://raw.githubusercontent.com/lucas-schierholt/my5G-RANTester-Script/main/stop_and_clear.sh)
#
...
if [ "$RUN_CORE_5G" = "1" ]; then
    source <(curl -s https://raw.githubusercontent.com/lucas-schierholt/my5GRANTester-Script/main/utils/open5gs.sh)
else
